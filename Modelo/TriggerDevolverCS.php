...
$sentencia2 = "CREATE TRIGGER `caja_sorpresa_backup_after_delete`
                AFTER DELETE ON `caja_sorpresa_backup` FOR EACH ROW 
                BEGIN
                    INSERT INTO caja_sorpresa VALUES(".$_caja->getId().", '".$_caja->getCodigo()."', ".$_caja->getAlto().", ".$_caja->getAncho().", ".$_caja->getProfundidad().", '".$_caja->getContenido()."', '".$_caja->getColor()."', '".$_caja->getFecha_alta()."');
